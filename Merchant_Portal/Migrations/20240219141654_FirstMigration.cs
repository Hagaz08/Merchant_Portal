        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    transReferenceNumber = table.Column<string>(type: "nvarchar(max)", nullable: false),
            ...
            migrationBuilder.InsertData(
                table: "Cards",
                columns: new[] { "Id", "UserId", "appuserId", "cardBalance", "cardName", "cardNumber", "cardType", "cardscheme", "cardstatus", "createdAt", "deletedAt", "expiryDate", "updatedAt" },
                values: new object[,]
                {
                    { "1", "92f5eaa0-0e23-4766-8a41-7658f7b125bb", null, 128.44999999999999, "Nosa Bless", "77048390", "physical", 2, 0, new DateTime(2024, 2, 19, 15, 16, 54, 500, DateTimeKind.Local).AddTicks(8228), null, new DateTime(2028, 2, 19, 15, 16, 54, 500, DateTimeKind.Local).AddTicks(8250), new DateTime(2024, 2, 19, 15, 16, 54, 500, DateTimeKind.Local).AddTicks(8244) },
                    { "2", "92f5eaa0-0e23-4766-8a41-7658f7b125bb", null, 456.44999999999999, "Eti Bless", "77048380", "Virtual", 0, 1, new DateTime(2024, 2, 19, 15, 16, 54, 500, DateTimeKind.Local).AddTicks(8264), null, new DateTime(2028, 2, 19, 15, 16, 54, 500, DateTimeKind.Local).AddTicks(8267), new DateTime(2024, 2, 19, 15, 16, 54, 500, DateTimeKind.Local).AddTicks(8265) },
                    { "3", "92f5eaa0-0e23-4766-8a41-7658f7b125bb", null, 128.44999999999999, "Chike Bless Bless", "77048370", "physical", 1, 2, new DateTime(2024, 2, 19, 15, 16, 54, 500, DateTimeKind.Local).AddTicks(8273), null, new DateTime(2028, 2, 19, 15, 16, 54, 500, DateTimeKind.Local).AddTicks(8276), new DateTime(2024, 2, 19, 15, 16, 54, 500, DateTimeKind.Local).AddTicks(8274) },
                    { "4", "92f5eaa0-0e23-4766-8a41-7658f7b125bb", null, 128.44999999999999, "Nosa Bless", "77048360", "physical", 2, 0, new DateTime(2024, 2, 19, 15, 16, 54, 500, DateTimeKind.Local).AddTicks(8296), null, new DateTime(2028, 2, 19, 15, 16, 54, 500, DateTimeKind.Local).AddTicks(8300), new DateTime(2024, 2, 19, 15, 16, 54, 500, DateTimeKind.Local).AddTicks(8297) }
                });
